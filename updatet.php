...
if(isset($_POST['update']))
{
  ...
  include('connect.php');
 //update
 $update="UPDATE courses SET type='$two',name='$name',mobileno='$mobileno',courselist='$courselist',coursefee='$coursefee' WHERE uid='$uiiid'";
...
<form action="" method="POST">
        ...
        <label for="lname">COURSEFEE:</label><br>
        <input type="number"  name="coursefee" required="required"><br>
